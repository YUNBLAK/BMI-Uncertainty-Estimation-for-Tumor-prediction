...
def saveTruthMaskImage(filename, new_size, output_folder):
    ...
    saved_name = output_folder + "/" + filename + "_truth_base.png"
...
def saveWSI(filename, new_size, output_folder):
    ...
    saved_name = output_folder + "/" + filename + "_WSI_base.png"
    resized_image.save(saved_name)
...
imgname = "../prediction_masks/" + globalfilename +  "_MASK_base" + ".png"
new_size = (num_patches_x * 65, num_patches_y*65)
...
imgname  = "../prediction_masks/" + globalfilename +  "_MASK_BIN_base" + ".png"
