...
Please move WSIs which you want to do patch-wise tumor prediction to `dataset` folder. Please remove `placeholder` file in `dataset` and `output` directory. This is the sample WSI datasets [WSI](https://drive.google.com/file/d/1cvfR9FwwuOz_aO5AdHvuJPLtEvhIaCpL/view?usp=sharing).
